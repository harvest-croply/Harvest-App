...
import 'edit_delete_farm_sheet_model.dart';

class EditDeleteFarmSheet extends StackedView<EditDeleteFarmSheetModel> {
  ...
  Widget builder(
    ...
    EditDeleteFarmSheetModel viewModel,
    Widget? child,
  ) {
    return Container(
  ...
  @override
  EditDeleteFarmSheetModel viewModelBuilder(BuildContext context) =>
      EditDeleteFarmSheetModel();
}
