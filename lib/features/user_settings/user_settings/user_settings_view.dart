...
class UserSettingsView extends StackedView<UserSettingsViewModel> {
  ...
  PreferredSizeWidget buildAppBar(UserSettingsViewModel viewModel) {
    return AppBar(
      elevation: 1,
      leadingWidth: 48,
      leading: Padding(
  ...
  Widget buildUserSettingsHeader() {
    return Row(
      children: [
        Image.asset(
          AssetsImages.avatar,
  ...
  Widget buildSettingsList(UserSettingsViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
